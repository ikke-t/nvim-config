  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      require('nvim-treesitter.configs').setup {
        ensure_installed = { 'bash', 'c', 'dockerfile', 'html', 'json', 'lua', 'markdown', 'python', 'vim', 'vimdoc', 'yaml' },
...
local cfg = require('yaml-companion').setup {
  -- Tried to follow the following guides:
  -- https://neovimcraft.com/plugin/someone-stole-my-name/yaml-companion.nvim
  -- https://www.arthurkoziel.com/json-schemas-in-neovim/
  -- https://www.redhat.com/en/blog/validating-openshift-manifests-in-a-gitops-world
  ...
  schemas = {
    ...
    },
    {
      ...
      name = 'Kubernetes 1.26.9',
      uri = 'https://raw.githubusercontent.com/yannh/kubernetes-json-schema/master/v1.26.9-standalone-strict/all.json',
    },
    {
      -- name = 'Kubernetes 1.22.4',
      -- uri = 'https://raw.githubusercontent.com/yannh/kubernetes-json-schema/master/v1.22.4-standalone-strict/all.json',
      name = 'OpanShift 4.14',
      uri = 'file:///var/home/itengval/src/ocp-json-schema/k8s-manifest-validation/schemas/openshift-json-schema/master-standalone',
    },
  },
...
require('mini.statusline').setup {
  sections = {
    statusline = { 'fileformat', 'filetype', get_schema },
  },
}
